...
#_____Formulário Hierárquico MESO_PBeneficiada ----
    observe({
      RegiaoIntermediaria <- 
        sort(
          unique(geocod[geocod$UF_sigla == input$id.UF.MESO.Beneficiada.select,]$Região.Intermediária.IBGE)
        )
...
#_____Formulário Hierárquico MICRO_PBeneficiada ----
    observe({
      RegiaoImediata <- 
        sort(
          unique(geocod[geocod$UF_sigla == input$id.UF.MICRO.Beneficiada.select,]$Região.Imediata.IBGE)
        )
...
#_____Formulário Hierárquico MET_PBeneficiada ----
    observe({
      RegiaoMetropolitana <- 
        sort(
          unique(geocod[geocod$UF_sigla == input$id.UF.MET.Beneficiada.select,]$Reg_Metropolitana)
        )
...
#_____  geom_col - output$id.Graf.HHI_Substancia_PBeneficiada_BR ----  
    output$id.Graf.HHI_Substancia_PBeneficiada_BR <-
      renderPlot({
        ggplot(data = HHI_Substancia_PBeneficiada_BR(),aes(x = Ano.Base.Ral)) +
          scale_y_continuous(sec.axis = sec_axis(trans = ~.)) +
          geom_line(aes(y = HHI), color = "brown") + geom_point(aes(y = HHI)) + 
          labs(x = "Ano", y = "") + 
          theme_bw(base_size = 14)
...
#_____  geom_col - output$id.Graf.Preco_Substancia_PBeneficiada_BR ----  
    output$id.Graf.preco_Substancia_PBeneficiada_BR <-
      renderPlot({
        ggplot(data = HHI_Substancia_PBeneficiada_BR(),aes(x = Ano.Base.Ral)) +
          scale_y_continuous(sec.axis = sec_axis(trans = ~.)) +
          geom_line(aes(y = `p(nominal)`), color = 'grey') + geom_point(aes(y = `p(nominal)`), shape = 1) + 
...
#_____  geom_col - output$id.Graf.CV_Substancia_PBeneficiada_BR ----  
    output$id.Graf.CV_Substancia_PBeneficiada_BR <-
      renderPlot({
        ggplot(data = HHI_Substancia_PBeneficiada_BR(),aes(x = Ano.Base.Ral)) +
          scale_y_continuous(sec.axis = sec_axis(trans = ~.)) +
          geom_line(aes(y = CV), color = "brown") + geom_point(aes(y = CV)) + 
...
#_____  geom_col - output$id.Graf.HHI_Substancia_PBeneficiada_UF ----  
    output$id.Graf.HHI_Substancia_PBeneficiada_UF <-
      renderPlot({
        ggplot(data = HHI_Substancia_PBeneficiada_UF(),aes(x = Ano.Base.Ral)) +
          scale_y_continuous(sec.axis = sec_axis(trans = ~.)) +
          geom_line(aes(y = HHI), color = "brown") + geom_point(aes(y = HHI)) + 
          labs(x = "Ano", y = "") + 
          theme_bw(base_size = 14)
...
#_____  geom_col - output$id.Graf.Preco_Substancia_PBeneficiada_UF ----  
    output$id.Graf.preco_Substancia_PBeneficiada_UF <-
      renderPlot({
        ggplot(data = HHI_Substancia_PBeneficiada_UF(),aes(x = Ano.Base.Ral)) +
          scale_y_continuous(sec.axis = sec_axis(trans = ~.)) +
          geom_line(aes(y = `p(nominal)`), color = "grey") + geom_point(aes(y = `p(nominal)`), shape = 1) + 
...
#_____  geom_col - output$id.Graf.CV_Substancia_PBeneficiada_UF ----  
    output$id.Graf.CV_Substancia_PBeneficiada_UF <-
      renderPlot({
        ggplot(data = HHI_Substancia_PBeneficiada_UF(),aes(x = Ano.Base.Ral)) +
          scale_y_continuous(sec.axis = sec_axis(trans = ~.)) +
          geom_line(aes(y = CV), color = "brown") + geom_point(aes(y = CV)) + 
...
#_____  geom_col - output$id.Graf.HHI_Substancia_PBeneficiada_MESO ----  
    output$id.Graf.HHI_Substancia_PBeneficiada_MESO <-
      renderPlot({
        ggplot(data = HHI_Substancia_PBeneficiada_MESO(),aes(x = Ano.Base.Ral)) +
          scale_y_continuous(sec.axis = sec_axis(trans = ~.)) +
          geom_line(aes(y = HHI), color = "brown") + geom_point(aes(y = HHI)) + 
          labs(x = "Ano", y = "") + 
          theme_bw(base_size = 14)
...
#_____  geom_col - output$id.Graf.Preco_Substancia_PBeneficiada_MESO ----  
    output$id.Graf.preco_Substancia_PBeneficiada_MESO <-
      renderPlot({
        ggplot(data = HHI_Substancia_PBeneficiada_MESO(),aes(x = Ano.Base.Ral)) +
          scale_y_continuous(sec.axis = sec_axis(trans = ~.)) +
          geom_line(aes(y = `p(nominal)`), color = "grey") + geom_point(aes(y = `p(nominal)`), shape = 1) + 
...
#_____  geom_col - output$id.Graf.CV_Substancia_PBeneficiada_MESO ----  
    output$id.Graf.CV_Substancia_PBeneficiada_MESO <-
      renderPlot({
        ggplot(data = HHI_Substancia_PBeneficiada_MESO(),aes(x = Ano.Base.Ral)) +
          scale_y_continuous(sec.axis = sec_axis(trans = ~.)) +
          geom_line(aes(y = CV), color = "brown") + geom_point(aes(y = CV)) + 
...
#_____  geom_col - output$id.Graf.HHI_Substancia_PBeneficiada_MICRO ----  
    output$id.Graf.HHI_Substancia_PBeneficiada_MICRO <-
      renderPlot({
        ggplot(data = HHI_Substancia_PBeneficiada_MICRO(),aes(x = Ano.Base.Ral)) +
          scale_y_continuous(sec.axis = sec_axis(trans = ~.)) +
          geom_line(aes(y = HHI), color = "brown") + geom_point(aes(y = HHI)) + 
          labs(x = "Ano", y = "") + 
          theme_bw(base_size = 14)
...
#_____  geom_col - output$id.Graf.Preco_Substancia_PBeneficiada_MICRO ----  
    output$id.Graf.preco_Substancia_PBeneficiada_MICRO <-
      renderPlot({
        ggplot(data = HHI_Substancia_PBeneficiada_MICRO(),aes(x = Ano.Base.Ral)) +
          scale_y_continuous(sec.axis = sec_axis(trans = ~.)) +
          geom_line(aes(y = `p(nominal)`), color = "grey") + geom_point(aes(y = `p(nominal)`), shape = 1) + 
...
#_____  geom_col - output$id.Graf.CV_Substancia_PBeneficiada_MICRO ----  
    output$id.Graf.CV_Substancia_PBeneficiada_MICRO <-
      renderPlot({
        ggplot(data = HHI_Substancia_PBeneficiada_MICRO(),aes(x = Ano.Base.Ral)) +
          scale_y_continuous(sec.axis = sec_axis(trans = ~.)) +
          geom_line(aes(y = CV), color = "brown") + geom_point(aes(y = CV)) + 
...
#_____  geom_col - output$id.Graf.HHI_Substancia_PBeneficiada_MET ----  
    output$id.Graf.HHI_Substancia_PBeneficiada_MET <-
      renderPlot({
        ggplot(data = HHI_Substancia_PBeneficiada_MET(),aes(x = Ano.Base.Ral)) +
          scale_y_continuous(sec.axis = sec_axis(trans = ~.)) +
          geom_line(aes(y = HHI), color = "brown") + geom_point(aes(y = HHI)) + 
          labs(x = "Ano", y = "") + 
          theme_bw(base_size = 14)
...
#_____  geom_col - output$id.Graf.Preco_Substancia_PBeneficiada_MET ----  
    output$id.Graf.preco_Substancia_PBeneficiada_MET <-
      renderPlot({
        ggplot(data = HHI_Substancia_PBeneficiada_MET(),aes(x = Ano.Base.Ral)) +
          scale_y_continuous(sec.axis = sec_axis(trans = ~.)) +
          geom_line(aes(y = `p(nominal)`), color = "grey") + geom_point(aes(y = `p(nominal)`), shape = 1) + 
...
#_____  geom_col - output$id.Graf.CV_Substancia_PBeneficiada_MET ----  
    output$id.Graf.CV_Substancia_PBeneficiada_MET <-
      renderPlot({
        ggplot(data = HHI_Substancia_PBeneficiada_MET(),aes(x = Ano.Base.Ral)) +
          scale_y_continuous(sec.axis = sec_axis(trans = ~.)) +
          geom_line(aes(y = CV)) + geom_point(aes(y = CV)) + 
...
#_____ TABELA GERAL - output$id.Tb.HHI.Beneficiada.BR ----  
    output$id.HHI_Substancia_PBeneficiada_BR <- 
      renderReactable({
        reactable(HHI_Substancia_PBeneficiada_BR()  
                  ,defaultColDef = colDef(align = "center")
                  ,theme = reactableTheme(cellStyle = list(fontSize = '11px')) 
                  ,filterable = FALSE
                  ,resizable = FALSE
...
#_____ TABELA GERAL - output$id.Tb.HHI.Beneficiada.UF ----  
    output$id.HHI_Substancia_PBeneficiada_UF <- 
      renderReactable({
        reactable(HHI_Substancia_PBeneficiada_UF()  
                  ,defaultColDef = colDef(align = "center")
                  ,theme = reactableTheme(cellStyle = list(fontSize = '11px')) 
                  ,filterable = FALSE
                  ,resizable = FALSE
...
#_____ TABELA GERAL - output$id.Tb.HHI.Beneficiada.MESO ----  
    output$id.HHI_Substancia_PBeneficiada_MESO <- 
      renderReactable({
        reactable(HHI_Substancia_PBeneficiada_MESO()  
                  ,defaultColDef = colDef(align = "center")
                  ,theme = reactableTheme(cellStyle = list(fontSize = '11px')) 
                  ,filterable = FALSE
                  ,resizable = FALSE
...
#_____ TABELA GERAL - output$id.Tb.HHI.Beneficiada.MICRO ----  
    output$id.HHI_Substancia_PBeneficiada_MICRO <- 
      renderReactable({
        reactable(HHI_Substancia_PBeneficiada_MICRO()  
                  ,defaultColDef = colDef(align = "center")
                  ,theme = reactableTheme(cellStyle = list(fontSize = '11px')) 
                  ,filterable = FALSE
                  ,resizable = FALSE
...
#_____ TABELA GERAL - output$id.Tb.HHI.Beneficiada.MET ----  
    output$id.HHI_Substancia_PBeneficiada_MET <- 
      renderReactable({
        reactable(HHI_Substancia_PBeneficiada_MET()  
                  ,defaultColDef = colDef(align = "center")
                  ,theme = reactableTheme(cellStyle = list(fontSize = '11px')) 
                  ,filterable = FALSE
                  ,resizable = FALSE
